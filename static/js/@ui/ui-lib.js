...
function h(t) {
  ...
  if (
    ...
    if (null != t) {
      null != t._nextDomNode && p(t._nextDomNode._vNode, null, "_prevDomNode"),
        null != t._prevDomNode &&
...
function DIFFCHILDREN(t, e, n, o, r, l, s) {
...
class S {
  ...
  render(t, e) {}
  setState(e) {
    const o = "function" == typeof e ? (e = e(this._nextState, this.props)) : e;
    var l;
    null != o &&
...
function k(t, e, s, i, u, p, c) {
  ...
  const _ = e.type;
  if (_ === a || s.type === a)
    return DIFFCHILDREN(e, d ? l : s._children || l, t, i, u, p, c);
  ...
  return (
    ...
    (e._dom._vNode = e),
    DIFFCHILDREN(e, d ? l : s._children || l, e._dom, i, u, e._component, c),
    e._dom
  );
}
function w(t, e) {
...
const U = c("div", null, "Loading.."),
  ...
  T = {
    ...
    unsubscribe(t) {
      for (let e = 0; e < L.length; e++) if (L[e] === t) return L.splice(e, 1);
    },
    emit(t, e) {
